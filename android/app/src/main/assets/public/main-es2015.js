...
const routes = [
    ...
    {
        path: 'partido',
        loadChildren: () => __webpack_require__.e(/*! import() | partido-partido-module */ "partido-partido-module").then(__webpack_require__.bind(null, /*! ./partido/partido.module */ "./src/app/partido/partido.module.ts")).then(m => m.PartidoPageModule)
    },
    {
        path: 'entrenamiento',
